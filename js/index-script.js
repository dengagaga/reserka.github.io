document.addEventListener("DOMContentLoaded", function (event) {
  ...
  s.charset = "UTF-8";
  s.src = "https://n896723.yclients.com/widgetJS";
  pageBody.append(s);
});
...
droplinks.forEach(link => {
  link.addEventListener('click', () => {
    ...
    if (link.textContent == 'Выгодные комплексы') {
      ...
      legs.style.display = "none"
      hands.style.display = "none"
      omgOne.classList.remove('img-list-none')
      omgTwo.classList.add('img-list-none')
      omgThree.classList.add('img-list-none')
      omgFour.classList.add('img-list-none')
      omgFive.classList.add('img-list-none')
      ...
      legs.style.display = "none"
      faceAndNeck.style.display = "block"
      omgTwo.classList.remove('img-list-none')
      omgOne.classList.add('img-list-none')
      omgThree.classList.add('img-list-none')
      omgFour.classList.add('img-list-none')
      omgFive.classList.add('img-list-none')
    }
      ...
      legs.style.display = "none"
      telo.style.display = "block"
      omgThree.classList.remove('img-list-none')
      omgTwo.classList.add('img-list-none')
      omgOne.classList.add('img-list-none')
      omgFour.classList.add('img-list-none')
      omgFive.classList.add('img-list-none')
      ...
      legs.style.display = "none"
      hands.style.display = "block"
      omgFour.classList.remove('img-list-none')
      omgTwo.classList.add('img-list-none')
      omgOne.classList.add('img-list-none')
      omgThree.classList.add('img-list-none')
      omgFive.classList.add('img-list-none')
      ...
      hands.style.display = "none"
      legs.style.display = "block"
      omgFive.classList.remove('img-list-none')
      omgTwo.classList.add('img-list-none')
      omgOne.classList.add('img-list-none')
      omgFour.classList.add('img-list-none')
      omgThree.classList.add('img-list-none')
    ...
    else if (link.textContent == 'Для новых клиентов') {
        tableLPG1.style.display = "block"
        tableLPG2.style.display = "none"
        tableLPG3.style.display = "none"
        omgOne.classList.remove('img-list-none')
    ...
    else if (link.textContent == 'Абонемент на 15 процедур') {
      tableLPG1.style.display = "none"
      tableLPG3.style.display = "block"
      tableLPG2.style.display = "none"
      omgOne.classList.add('img-list-none')
...
const omgOne = document.querySelector('.omg-one')
const omgTwo = document.querySelector('.omg-two')
const omgThree = document.querySelector('.omg-three')
const omgFour = document.querySelector('.omg-four')
const omgFive = document.querySelector('.omg-five')
...
tableBtnLPG.forEach(btnLpg => {
  btnLpg.addEventListener('click', function() {
      ...
      else if(btnLpg.textContent == 'Для новых клиентов') {
        tableLPG1.style.display = "block"
        tableLPG2.style.display = "none"
        tableLPG3.style.display = "none"
      }
      else if(btnLpg.textContent == 'Абонемент на 15 процедур') {
        tableLPG1.style.display = "none"
        tableLPG3.style.display = "block"
          tableLPG2.style.display = "none"
      }
...
const navTop = document.querySelector('.nav__item-top')
const navBot = document.querySelector('.nav__item-bot')
const imgDownStr = document.querySelector('.img-down-str')

navTop.addEventListener('click', function() {
	navBot.classList.toggle('dics')
	imgDownStr.classList.toggle('rotate-images')
  })


  const lazerImgClick = document.querySelectorAll('.lazer-zone-click')

  const lbClose = document.querySelector(".lb-close")


  const modal10 = document.querySelector(".modal_10-all")
  const modal10Svg = document.querySelector(".modal_10-svg")
  modal10Svg.addEventListener('click', function() {
    modal10.classList.add('none-modal10')
    const body = document.body
        body.classList.remove('body-active_fon')
    })
  
  
    window.addEventListener('load', function() {
      setTimeout(function() { //ждём 15 секунд
        modal10.classList.remove('none-modal10')
        const body = document.body
        body.classList.add('body-active_fon')
      }, 10000);
   });
